...
struct AppConstants {
    ...
    let kAPIBaseURL: String = ""
    let kAPIForgotPasswordPath: String = ""
    let kAPISignupPath: String = ""
    let kAPISigninPath: String = ""
    let kAPIUpdateProfilePath: String = ""
    let kAPIChangePasswordPath: String = ""
    ...
    let kValidationMessageInvalidInput: String = "Please enter valid information"
    ...
    let kPhoneNumberRequiredLength: Int = 4
