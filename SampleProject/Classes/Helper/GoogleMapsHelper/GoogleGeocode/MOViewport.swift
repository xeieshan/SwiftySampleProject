...
public final class MOViewport: NSCoding {
  ...
  public required init(json: JSON) {
    northeast = MONortheast(json: json[SerializationKeys.northeast])
    southwest = MOSouthwest(json: json[SerializationKeys.southwest])
  }
  ...
  required public init(coder aDecoder: NSCoder) {
    self.northeast = aDecoder.decodeObject(forKey: SerializationKeys.northeast) as? MONortheast
    self.southwest = aDecoder.decodeObject(forKey: SerializationKeys.southwest) as? MOSouthwest
  }
